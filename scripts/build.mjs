...
const minifiedScript = await minifyScript(script[1], { compress: { passes: 3 }, mangle: { toplevel: true, reserved: ['state', 'settings', 'activeView', 'selectedWeek', 'isMobile', 'render', 'parseXlsx', 'parseDocx', 'parseHtml'] }, format: { comments: false } });
